...
EN.app = (function () {
  ...
  /* A tab may carry an SVG icon instead of a text glyph. Every one is the author's own art with
     its path copied unchanged; they are inline rather than <img> so each takes the tab's current
     colour on every skin, and `glyph` stays beside them for the stub page and anything else that
     wants a character. */
  ...
  // the author's operative silhouette, for Freelancer alone
  var ICON_FREELANCER = '<svg viewBox="0 0 122.88 121.42" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M0,121.42l0-19.63c10.5-4.67,42.65-13.56,44.16-26.41c0.34-2.9-6.5-13.96-8.07-19.26 c-3.36-5.35-4.56-13.85-0.89-19.5c1.46-2.25,0.84-10.44,0.84-13.53c0-30.77,53.92-30.78,53.92,0c0,3.89-0.9,11.04,1.22,14.1 c3.54,5.12,1.71,14.19-1.27,18.93c-1.91,5.57-9.18,16.11-8.56,19.26c2.31,11.74,32.13,19.63,41.52,23.8l0,22.23L0,121.42L0,121.42z"/></svg>';
  ...
  // the author's memory stick with an info mark cut into it, for the Codex. It stands where a
  // book used to: the rules are something you carry in a slot on this sheet, not something you
  // shelve. The author's second cut squares the viewBox and widens the stick through the <g>'s
  // own non-uniform scale, so it holds more of the square icon cell than the first cut did; the
  // transform is the drawing, and stripping it would collapse the art back into a corner.
  var ICON_CODEX = '<svg viewBox="0 0 2599 2599" fill="currentColor" aria-hidden="true"><g transform="matrix(19.613046,0,0,12.930176,255.516767,-259.143637)"><path fill-rule="evenodd" clip-rule="evenodd" d="M93.108,20.042L103,37L103,69L97,69C95.667,69 95,69.667 95,71L95,98C95,100 96,101 98,101L103,101L103,210C103,217.333 100.333,221 95,221L9,221C4.333,221 2,219 2,215L2,182L7,176L7,166L2,166L2,150L13,139L13,23C13,21.236 13.778,20.25 15.334,20.042L93.108,20.042ZM55,27L55,51L65,51L65,27L55,27ZM97.042,210.45C97.042,209.256 96.404,208.286 95.618,208.286L9.382,208.286C8.596,208.286 7.958,209.256 7.958,210.45L7.958,214.779C7.958,215.974 8.596,216.943 9.382,216.943L95.618,216.943C96.404,216.943 97.042,215.974 97.042,214.779L97.042,210.45ZM79,27L79,51L88,51L88,27L79,27ZM20,27L20,51L29,51L29,27L20,27ZM32,27L32,51L41,51L41,27L32,27ZM43,27L43,51L53,51L53,27L43,27ZM67,27L67,51L76,51L76,27L67,27ZM54.122,173.346L71.929,114.542L71.959,114.333C71.946,113.977 71.643,113.694 71.287,113.706L29.254,115.024C28.959,115.021 28.697,115.218 28.618,115.502L26.456,123.371L26.42,123.598C26.421,123.956 26.715,124.251 27.073,124.253L35.299,124.253C39.34,124.253 40.976,126.65 40.52,130.357C40.242,132.585 39.481,134.957 38.878,137.12L29.469,165.621C27.604,171.601 25.653,178.547 28.024,184.661C31.775,194.343 44.875,194.867 53.172,191.654C56.153,190.495 59.062,188.764 61.899,186.466L61.944,186.433C64.781,184.141 67.582,181.24 70.345,177.743C73.085,174.271 75.796,170.2 78.477,165.539C78.659,165.251 78.595,164.863 78.317,164.659L72.486,160.333C72.385,160.273 72.27,160.241 72.152,160.241C71.923,160.241 71.71,160.362 71.592,160.56C69.872,163.429 68.219,166.004 66.646,168.25C65.068,170.501 63.548,172.455 62.088,174.108C60.652,175.73 59.369,176.955 58.251,177.761C57.22,178.511 56.355,178.891 55.675,178.891C52.541,178.891 53.598,175.221 54.122,173.346ZM47.803,89.329C47.803,91.323 48.149,93.173 48.845,94.881C49.537,96.59 50.584,98.153 51.976,99.58C53.372,100.997 54.922,102.067 56.61,102.78C58.309,103.489 60.157,103.847 62.152,103.847C64.101,103.847 65.91,103.482 67.582,102.767C69.248,102.047 70.778,100.971 72.167,99.545C73.564,98.115 74.607,96.541 75.302,94.84C75.999,93.136 76.346,91.293 76.346,89.329C76.346,87.306 75.996,85.434 75.298,83.718C74.604,82.003 73.556,80.446 72.162,79.047C70.767,77.643 69.237,76.584 67.569,75.872C65.902,75.166 64.093,74.805 62.152,74.805C60.213,74.805 58.401,75.166 56.718,75.874C55.043,76.584 53.492,77.643 52.073,79.039C50.65,80.438 49.581,81.999 48.871,83.714C48.159,85.434 47.803,87.306 47.803,89.329Z"/></g></svg>';
  ...
  var TABS = [
    { key: "combat",  label: "Freelancer", glyph: "✦", icon: ICON_FREELANCER, sub: "live play dashboard", portal: "freelancer", gated: registered, view: function (m) { EN.combatView.render(m); } },
