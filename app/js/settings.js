...
EN.settings = (function () {
  ...
  function diceSection() {
    ...
    return [
      ...
      // stretch, not the .row default of centre: one button carries an SVG and the other a text
      // glyph, so their content boxes differ by 2px and they would sit at different heights
