...
EN.combat = {
  ...
  /* How far Reach can be pushed. A weapon's own Reach plus everything a character
     ...
     Author ruling 2026-08-11. A manuscript update to match is pending, so the trait
     text in gear_traits.js still describes Reach without the cap. */
  reachCap: { rigid: 2, flexible: 3 },
  reachCapText: "Reach caps out at Reach 2 for rigid weapons (blades, blunts, and shaft weapons) and Reach 3 for flexible weapons (whips and filament weapons). Bonuses past the cap are wasted.",
