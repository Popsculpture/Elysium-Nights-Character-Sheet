...
EN.grid = {
  ...
  buddyCiphers: [
    ...
    { name: "Access Override ⇋", type: "Utility", exec: "1 Action", range: "Touch (linked)", text: "• **Fail:** Lock or unlock the mechanism. * **Success:** Lock resists; IC retaliates." },
    { name: "Hijack Stream ⇋", type: "Detection", exec: "1 Action", range: "12 spaces", text: "• **Fail:** Clone or reroute the feed. * **Success:** Access denied; IC retaliates." },
    ...
    { name: "Data Extraction ⇋", type: "Utility", exec: "1 Swift Action", range: "Touch", text: "• **Fail:** Clean copy, no trace. * **Success:** You still get the data, but IC retaliates and leaves a forensic trail." }
  ],
