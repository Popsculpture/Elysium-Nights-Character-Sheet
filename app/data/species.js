    ...
    lineages: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Entropic Lash", text: "You can force a sliver of your own unstable existence into another body, accelerating its decay. As a Swift Action, choose a Target within 3 spaces; it takes 2d6 Entropy damage and cannot regain Vitality or Wounds until the start of its next turn. You can use this feature a number of times equal to your Caliber per Long Rest." },
          { name: "Temporal Snare", text: "You snag a foe in a pocket of stalled time, leaving them a half-step behind the world. Once per scene as a Swift Action, choose a Target within 6 spaces. Until the end of its next turn, its Speed is halved and it cannot take Impulse Actions or Swift Actions." },
    ...
    lineages: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Pollen Haze", text: "You flood the air around you with a heady cloud of disorienting pollen. Once per Encounter as an Action, each organic Target of your choice within 2 spaces must make a Wits Save (8 + your Charm modifier + your Caliber). On a failure, until the end of its next turn the Target takes Snag on its attack rolls and cannot take Impulse Actions. On a success, it instead takes Snag on its next attack roll only." },
    ...
    lineages: [
      {
        ...
        features: [
          ...
          { name: "Hydraulic Throw", text: "With the leverage of industrial pistons, you can hurl whatever you hold. As an Action, you can throw a Target you have Grappled, or an unattended object, up to 4 spaces. Either one must be your Size or smaller. A thrown Target takes 1d8 Bludgeoning damage and is knocked Prone. If you throw it into another Target along the way, that second Target takes the same damage, and you choose which of the two is knocked Prone." },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Vital Static", text: "Every sign of life in your body is a setting, and you know where the off switch is. As an Action, you suppress your simulated pulse, breath, body heat, and micro-movements entirely, appearing to be a corpse or a powered-down chassis. While suppressed, you remain fully aware of your surroundings. You can hold this state for up to one hour and end it as a Free Action, acting normally on the same turn you wake. Any check made by anyone living to determine that you are alive or active is an opposed check against your Deception, no matter how trained they are. A machine scanner probing beneath the flesh makes the same opposed check but with Edge, since your synthetic internals never fully sleep." },
    ...
    lineages: [
      {
        ...
        features: [
          ...
          { name: "Survivor's Wrath", text: "Pain does not slow your bloodline. It focuses it. Once per Encounter, when you are reduced below half your Vitality, you may immediately regain Vitality equal to your Caliber as a Special Action, and you gain Edge on the next melee attack roll you make before the end of your next turn." },
    ...
    lineages: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Probability Nudge", text: "Reality bends around you in small, mischievous ways. Once per Encounter as a Special Action, you can force one Target within 6 spaces to reroll any single die roll they just made. They must use the new result, for better or worse." },
