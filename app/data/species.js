    ...
    lineages: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Synthetic Musculature", text: "Your muscle fibers are interlaced with synthetic carbon nanotubes. You increase your Encumbrance Threshold by 2 and count as one Size larger for Shove, Trip, and Grapple, and your unarmed strike damage die steps up one size (a strike with no die gains 1d4)." },
    ...
    lineages: [
      {
        ...
        features: [
          ...
          { name: "Hydraulic Throw", text: "With the leverage of industrial pistons, you can hurl whatever you hold. As an Action, you can throw a Target you have Grappled or an unattended object of your Size or smaller up to 4 spaces. A thrown Target takes 1d8 Bludgeoning damage and is knocked Prone. If you throw it into another Target along the way, that second Target takes the same damage, and you choose which of the two is knocked Prone. You can throw a Target only if it is your Size or smaller." },
