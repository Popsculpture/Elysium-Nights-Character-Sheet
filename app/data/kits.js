...
EN.kits = {
  ...
  gmGuidance: "A Fury in the Composite Kit carrying a Warhammer and the Engineering Toolkit is carrying 6 Load: 2 for Medium Armor, 2 for the weapon, 2 for a full toolkit. Against the Encumbrance Threshold (6 + Body Modifier, minimum 3), that lands exactly at a Standard Loadout's Load Budget at Body +0, still Unencumbered, and comfortably under it at the +2 or +3 a Fury usually runs. The Axe's Heavy trait reads as Load 3 and lands the same build at 7, one over the Body +0 threshold. Swap in Liner Mesh and the Warhammer total drops to 5. The lighter classes carry less across the board and land further under their own Threshold no matter which options they take, which leaves room to use Packed It when the job goes sideways."
};
