...
EN.gearCatalog.ranged = {
  ...
  items: [
    ...
    /* ---- Bowfire ---- */
    { name: "Compound Bow", group: "Bowfire", slots: 5, price: 350, damage: "1d10 Piercing", ammo: 1, range: "16 / 48",
    ...
    { name: "Crossbow", group: "Bowfire", slots: 5, price: 300, damage: "1d12 Piercing", ammo: 1, range: "20 / 60",
    ...
    { name: "Hand Crossbow", group: "Bowfire", slots: 4, price: 180, damage: "1d6 Piercing", ammo: 1, range: "8 / 24",
    ...
    { name: "Recurve Bow", group: "Bowfire", slots: 2, price: 200, damage: "1d8 Piercing", ammo: 1, range: "12 / 36",
    ...
    { name: "Slingshot", group: "Bowfire", slots: 2, load: 1, price: 15, damage: "1d4 Bludgeoning", ammo: 1, range: "6 / 18",
  ...
  traits: {
    ...
    "Crew Served": "Solo Operation: a single operator fires with Snag and cannot use the Dash action while carrying it. Assisted Operation: an Ally within 1 space can spend a Swift Action on their turn to act as the Loader/Spotter. While assisted, the gunner loses the Snag penalty, gains Edge on their next attack, and any Jam or Mishap from a Natural 1 is immediately cleared by the loader.",
    ...
    "Scoped": "When you Take Aim (Swift Action) before attacking with this weapon, that attack ignores the long-range Snag penalty and treats the Target\u0027s Half or Three-Quarter Cover as one step less: Three-Quarter becomes Half, Half becomes none.",
...
EN.gearCatalog.ammo = {
  ...
  items: [
    ...
    { name: "Spike Rounds", group: "Specialty", price: 250, unit: "per 5", availability: "Rare", legality: "Contraband",
      ...
      effect: "Against significant cyberware, drones, or smart devices: normal Ballistic damage plus a digital payload; Tech Save DC 14 or gain Breached until the end of their next turn, and any ally jacked into the #GRID may immediately attempt a follow-up intrusion as if Linked. Purely organic targets take normal damage and nothing else." },
    ...
    { name: "EMP Shell", group: "Launcher Shell", price: 80, unit: "each", availability: "Uncommon", legality: "Restricted",
      ...
      effect: "2d6 Electric and Tech. Living targets without significant cybernetics take half, Electric only, no further effect. Devices, drones, cyberware, powered armor and smart weapons take full damage and make a Tech Save vs your Weapon Save DC or gain Bricked or Breached until the end of their next turn." },
