...
EN.gearCatalog.signature = {
  ...
  items: [
    ...
    // flexible: a filament on a spool, so it caps at the higher Reach. See EN.combat.reachCap.
    { name: "Nanowire", signature: true, kind: "melee", group: "Martial", proficiency: "Martial Weapons", load: 1, flexible: true,
    ...
    { name: "Pile Driver", signature: true, kind: "melee", group: "Martial", proficiency: "Martial Weapons",
      ...
      desc: "A piston braced along the forearm that rams a hardened spike through whatever it touches, one brutal stroke at a time. Slow to reset, loud as a slammed vault door, and almost unfair against anything wearing plate. Favored by breachers, repo crews, and people with a grudge against doors.",
    ...
    { name: "Rip-Saw", signature: true, kind: "melee", group: "Martial", proficiency: "Martial Weapons",
      ...
      desc: "A motorized cleaver with a chain edge that screams before it bites and keeps screaming after. Subtle as a fire alarm. Nobody who hears one ever forgets the sound, which is rather the problem with carrying it.",
    ...
    { name: "Slab Blade", signature: true, kind: "melee", group: "Martial", proficiency: "Martial Weapons",
      ...
      effect: "On Hit: The swing carries through. One target adjacent to the target you struck takes the weapon's damage as well. Slow holds you to one attack each round; unless you're built for it, though, with cyberware that raises your Body and a Body of 18 or higher, the weight stops mattering: you ignore Slow on this weapon and attack as often as your other features allow." },
    ...
    { name: "Coil Driver", signature: true, kind: "ranged", group: "Heavy", proficiency: "Heavy Weapons",
      ...
      effect: "On Hit: Choose a target in range and a straight line from you through it, out to the Area 8 Line. Make one attack roll against that first target; on a hit it takes full damage. Everyone in the line makes an Agility save vs your Weapon Save DC, taking full damage on a failure and half on a success. Armor Piercing 3 applies to all of them." },
    ...
    { name: "Harpoon Gun", signature: true, kind: "ranged", group: "Bowfire", proficiency: "Bowfire Weapons",
      ...
      effect: "On Hit: The harpoon embeds and the line stays taut. On your following turns, you may spend a Swift Action to either drag the target up to 4 spaces toward you (the target may resist with a Body check vs your Weapon Save DC) or, if the harpoon struck a fixed and heavy anchor, pull yourself up to 4 spaces toward it. The line can be cut with an Action." },
    { name: "Net Launcher", signature: true, kind: "ranged", group: "Thrown", proficiency: "Thrown Weapons",
      ...
      effect: "On Hit: The target makes an Agility save vs your Weapon Save DC or is Restrained. Anyone Restrained by the net can spend an Action on a Body check (DC equal to your Weapon Save DC) to tear free, or an ally can cut them loose." },
