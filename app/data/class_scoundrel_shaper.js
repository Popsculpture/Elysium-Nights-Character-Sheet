...
EN.classes.scoundrel = {
  ...
  progressionTable: [
    { level: 1, caliber: 1, features: ["Moxie", "Cheap Shot (1d6)", "Scoundrel Subclass"], resource: "0" },
...
EN.classes.shaper = {
  ...
  progressionTable: [
    ...
    { level: 6, caliber: 3, features: ["Rhythmic Shaping", "Universal Upgrade"], resource: "+5 Points" },
    { level: 7, caliber: 4, features: ["Subclass Feature", "Master Forging"], resource: "0" },
    { level: 8, caliber: 4, features: ["Universal Upgrade"], resource: "0" },
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          text: "As an **Action**, spend 2 FP to target an Area 4 Cube within 12 spaces. Enemies in the area must make an Agility Save against your Flow Save DC. On a failure, they take 4d6 Bludgeoning damage and are Restrained by the roots. The area becomes Difficult Terrain for your enemies, but your allies move through it freely and heal 1d4 Vitality the first time they enter the zone on their turn."
        },
        {
          level: 10,
  ...
  extra: {
    ...
    coreChanneling: "You do not memorize static spells; you shape the current on the fly. You begin play knowing three Base Resonances chosen from the standard list: Kinetic, Thermal, Electromagnetic, Visceral, or Spatial. A Sourcerer is the exception: Synthetica counts as one of those three, so they choose only two more from the standard list. When you channel the Flow, you spend FP to build an Invocation using your known Resonances combined with the Intent, Delivery, Force, and Duration rules. At Level 3 you may learn the Cognitive Base Resonance (total four); at Level 5 you may learn the Temporal Base Resonance (total five).",
    resonances: {
