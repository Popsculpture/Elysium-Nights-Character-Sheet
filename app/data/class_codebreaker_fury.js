...
EN.classes.codebreaker = {
  ...
  featuresByLevel: {
    "1": [
      { name: "Bandwidth", text: "**Bandwidth** represents your ability to force your will upon a node, overclock your Smartdeck, and execute the exploits that define the Codebreaker class. Your mind is built for the #GRID's data streams. This is how you cash that in.\n\n**Your Bandwidth Pool**\n\nYour maximum Bandwidth equals your **Caliber + your Tech Modifier** (minimum 1). You regain all spent Bandwidth at the end of a Short or Long Rest.\n\n**Your Repertoire**\n\nYou are a Power User on the #GRID. You begin play with a **Tier 0 (Standard) Smartdeck** and a custom **Repertoire** of Ciphers: your own slice of the wider Cipher Library, the code you've paid for, cracked open, and learned to run without looking. You start with **four Ciphers** of your choice from the Complexity 0 or Complexity 1 tiers.\n\nYou can integrate additional Ciphers into your Repertoire by spending the required Material Cost and one uninterrupted Downtime period (8 hours). There is no upper limit on how many Ciphers you can know. The only limit is what you can afford and what your Smartdeck can run.\n\nYour Smartdeck's tier determines which Ciphers you can execute. A Smartdeck can run Ciphers up to **(Smartdeck Tier + 1) in Complexity**: a Tier 0 (Standard) deck runs Complexity 0-1; a Tier 5 (Apex) deck runs the entire Cipher library. Ciphers above your deck's capacity can be added to your Repertoire, but they will not execute until you upgrade your hardware.\n\n**Multi-Link**\n\nYou can sustain multiple simultaneous Links, unlike Standard Users who are capped at one. Your active Link limit is **twice your Caliber**. More Links means more leverage, and more leverage means the consequences of a failed Stability Check hit harder.\n\n**Cipher Casting Costs**\n\nBandwidth fuels every Cipher above the most basic tier. Complexity 0 Ciphers are free. Complexity 1-3 cost 1 Bandwidth. Complexity 4-5 cost 2 Bandwidth, or 1 on an Apex Smartdeck, whose Quantum Core runs the top of the library for less. **Signature Ciphers** (Logic Bomb, Daisy Chain, Puppet String, System Cascade, Black Sun) cost a flat 1 Bandwidth regardless of Complexity.\n\n" + CODEBREAKER_GRID_EXPLOITS_TEXT },
      ...
      { name: "Codebreaker Subclass", text: "You choose a Codebreaker subclass, representing your specialization. You gain all subclass features for which you meet the required Codebreaker level, both now and as you advance. You may only select one subclass." }
    ],
    "2": [
      { name: "Wireless Root Access", text: "The wall stops being cover. You no longer need line of sight to interact with the #GRID. You can Scan, Breach, and establish Links with any Node within **24 spaces**, even through solid walls, provided the target is not encased in a Faraday cage or shielded by Elite or Apex tier countermeasures." },
  ...
  subclasses: [
    {
      key: "rigger",
      name: "The Rigger",
      description: "You do not just manipulate data; you manipulate chrome. You are an absolute master of remote physical assets, using your Smartdeck and Bandwidth to command drones, vehicles, and automated turrets. By forming a seamless neural link with your machines, you make sure that you are never fighting alone.",
      features: [
        { level: 1, name: "Hardware Integration", text: "You treat physical machines as extensions of your nervous system. You gain the following benefits:\n\n• **Tool Proficiency:** Proficiency with Engineering Tools, letting you repair and customize robotic assets.\n• **Persistent Link:** You begin play with a custom Companion Drone (profile below). You maintain a permanent Link to it that does not count against your maximum active Links. If the drone is destroyed, you can rebuild it during a Long Rest by spending 𝒢100 in salvage and succeeding on an Engineering Dice Pool check (GM sets the Snag Dice; 2 is typical). On a failure, the salvage is wasted and the drone cannot be rebuilt until your next Long Rest.", nested: [{ name: "Companion Drone (Base Profile)", text: "• **Size:** Small (a rotor-drone, mechanical hound, treaded scout, or similar).\n• **Speed:** 6. Choose Flying, Climbing, or Ground movement when you build it.\n• **Defense:** 12 + your Tech Modifier.\n• **Vitality:** 10 + (Codebreaker Level × 4).\n\n• **Action Economy:** On your turn, spend an Impulse Action to command the drone to move up to its Speed and take one Action (attack, interact with an object, or take the Help action).\n• **Attack:** Mounted Sidearm or Taser. d20 + your Tech Modifier vs Defense; deals 1d6 + Tech Modifier Piercing or Electric damage." }] },
    ...
    },
    {
      ...
      features: [
        ...
        { level: 7, name: "Memetic Virus", text: "As an **Action**, spend 2 Bandwidth and force up to three enemies within 12 spaces to make a Wits Save (8 + Tech mod + Systems Proficiency Bonus). On a failure, they perceive an inescapable threat for 1 minute: they are Frightened of you and must use their movement to get away from you on their turn. If a Frightened target willingly moves closer to you, the dissonance deals it 4d6 Psychic damage. An affected target may repeat the Wits Save at the end of each of its turns to end the effect." },
        { level: 10, name: "Reality Overwrite", text: "Once per Long Rest, as an **Action**, spend 2 Bandwidth to overwrite an Area 20×20 Cube for 1 minute. Your squad is immune to the illusion, and your hardware bypasses the hard-light. All enemies inside the zone suffer:\n\n• **Foveated Disorientation:** The shifting labyrinth counts as Difficult Terrain (halving Speed), and they suffer continuous Snag on all attack rolls.\n• **Asymmetric Reality:** Because the hard-light solidifies only in response to enemy interactions, you control the battlefield's physical layout. Projections intercept enemy fire and block enemy Line of Sight; you and your allies gain Total Cover against ranged attacks made by enemies inside the zone.\n• **Sensory Rejection:** At the start of each of their turns, enemies must make a Wits Save (8 + Tech mod + Systems Proficiency Bonus). **On a failure:** They take 4d6 Psychic damage. **On a success:** They take half damage and map the geometry. Until the end of that turn, they ignore the area's Difficult Terrain penalty and your squad's Total Cover benefit; if they start their next turn still inside, they make that Wits Save with Edge." }
      ]
    },
    {
      key: "burner",
  ...
  extra: {
    playbook: {
      turnToTurn: "Balance meatspace awareness with #GRID operations. You will spend most rounds either establishing Links, injecting Ciphers, or spending Bandwidth on #GRID Exploits to enhance both. As you level, your action economy expands and your Bandwidth pool grows, allowing you to maintain pressure on multiple fronts at once.",
...
// at Level 1 and two more at Level 5 via Expanded Overdrive, so a character holds 4 of the 10.
//
// REWRITTEN 2026-08-24 against the current Part 1. The list grew from 8 to 10, the *Cornered*
// keyword became *I See Red*, and five Maneuvers were renamed. `action` carries the book's own
// short form ("Swift", not "Swift Action"); combat.js:shortAction accepts either and the composed
// prose then reads "(Swift)" exactly as printed.
var FURY_OVERDRIVE_INTRO = "The Fury runs on explosive bursts of adrenaline, cybernetic power, or pure rage. **Overdrive** represents physical feats that push past normal bodily limits.\n\n**Your Overdrive Pool**\n\nYour maximum Overdrive equals your **Caliber + your Body Modifier** (minimum 1). You regain all spent Overdrive at the end of a Short or Long Rest.\n\n**Overdrive Maneuvers**\n\nAt 1st Level, you learn two **Overdrive Maneuvers**, techniques fueled by adrenaline, violence, and the willingness to push your body past where it was meant to stop. You learn two additional Maneuvers at 5th Level through **Expanded Overdrive**. Unless otherwise noted, all Overdrive Maneuvers cost **1 Overdrive** to activate.\n\n**I See Red**\n\nPain does not slow a Fury down. It burns away everything that was holding them back. Some Maneuvers are marked **I See Red**. While you are **Bloodied**, an **I See Red** Maneuver gains the additional effect listed in its description.";

/* THE RENAME TABLE, read by store.js rather than restated there, the same way weapon parts and
   cyberware carry their own. Order is irrelevant here because the migration maps each stored
   name through this table EXACTLY ONCE; it never rewrites in place.

   That single-pass rule is not a style preference, it is the whole correctness argument.
   "Wrecking Ball" is a COLLISION, not a rename: the old melee strike of that name is now
   "Beyond the Bone", while the name itself was reused for what used to be "Bring the House
   Down". Rewriting in place would send "Bring the House Down" to "Wrecking Ball" and then on
   to "Beyond the Bone", landing every structure-demolition pick on a melee strike. */
var FURY_MANEUVER_RENAMES = [
  { oldName: "Bring the House Down", name: "Wrecking Ball" },
  { oldName: "Clear the Path", name: "Warhead" },
  { oldName: "Seismic Stomp", name: "Crash and Crack" },
  { oldName: "Linebreaker", name: "War Horse" },
  { oldName: "Redline", name: "Gimme Fuel" },
  { oldName: "On Me", name: "Churning My Direction" },
  { oldName: "Make an Example", name: "On I Burn" },
  { oldName: "Wrecking Ball", name: "Beyond the Bone", reused: true }
];

var FURY_OVERDRIVE_MANEUVERS = [
  { name: "Beyond the Bone", action: "Action", cost: 1, text: "You leave them with fewer working parts than they started with.\n\nTarget one Enemy within your melee reach. Make a standard melee attack. On a hit, deal an additional **1d8 Bludgeoning damage** and the target gains **1 stack of Bleeding**.\n\n• ***I See Red:*** The target gains **2 stacks of Bleeding** instead and is knocked *Prone*." },
  { name: "Warhead", action: "Action", cost: 1, text: "The first impact is only half the damage.\n\nTarget one Enemy within your melee reach. Make a standard melee attack. On a hit, deal normal damage and push the target up to **3 spaces** directly away from you. If the target is pushed into a solid obstacle, such as a wall, vehicle, or another target, both the target and the obstacle take additional **Bludgeoning damage equal to your Body Modifier**." },
  { name: "Crash and Crack", action: "Action", cost: 1, text: "One good hit in the right place and everyone nearby feels it.\n\nYou slam the ground with devastating force. All Enemies within **3 spaces** must make an **Agility Save** (DC = 8 + your Body Modifier + your Caliber). On a failure, they take **Bludgeoning damage equal to your Caliber + your Body Modifier** and gain the *Staggered* condition until the end of their next turn." },
  /* NOT the old Wrecking Ball. This name was REUSED for what was "Bring the House Down"; the
     melee strike that used to own it is now "Beyond the Bone". See FURY_MANEUVER_RENAMES. */
  { name: "Wrecking Ball", action: "Action", cost: 1, text: "Sometimes the shortest way through is straight through.\n\nTarget one section of wall, pillar, vehicle, barricade, or similar structure within your melee reach, up to **Heavy** in construction, or a point on the ground within reach. The section is torn apart or the floor is cratered. The area within **2 spaces** of that point becomes **Difficult Terrain** from the wreckage, and any Cover the destroyed object was providing is gone.\n\nEach Enemy within 2 spaces must succeed on an **Agility Save** (DC = 8 + your Body Modifier + your Caliber) or be knocked *Prone* and take **Bludgeoning damage equal to your Caliber** from flying debris.\n\n**Hardened** construction does not come apart in one swing. Vault doors, bunker walls, and armored hulls take the hit and hold. Chew through those the ordinary way, and let **Collateral Damage** do the work." },
  { name: "War Horse", action: "Swift", cost: 1, text: "Once you start moving, anything between you and where you are going has two choices: move, or be moved.\n\nUntil the end of your turn, you can move through spaces occupied by Enemies. Any Enemy whose space you pass through must make a **Body Save** (DC = 8 + your Body Modifier + your Caliber) or be knocked *Prone*." },
  /* cost 0 is load-bearing, not a placeholder: the entry says outright that Gimme Fuel costs no
     Overdrive to activate, which is what stops it being the no-op it would be if it cost 1 to
     refund 1. combat.js renders no resource chip for a falsy cost, which is correct here. */
  { name: "Gimme Fuel", action: "Swift", cost: 0, text: "When the tank runs dry, you are not empty until there is nothing left to burn.\n\nOnce per turn, you can take Vitality damage equal to your Caliber to regain 1 spent Overdrive. Gimme Fuel itself costs no Overdrive to activate. This damage cannot be reduced or prevented, and you cannot exceed your maximum Overdrive." },
  /* The game's first variable-cost ability. `cost` carries the MINIMUM; the ceiling is the
     general Variable Costs rule in EN.rules.resources, which caps any single activation at the
     character's Caliber. combat.js reads costVariable to render the range rather than a flat 1. */
  { name: "Gimme Fire", action: "Swift", cost: 1, costVariable: true, text: "You can always hit harder. More fuel means more violence, so make every hit count.\n\nSpend **1 or more Overdrive**. Until the end of your turn, each of your weapon attacks deals an additional **1d10 damage of the weapon's type for each Overdrive spent**.\n\n• ***I See Red:*** Each Overdrive spent instead adds **2d10 damage**, and your attacks ignore **Resistance** until the end of your turn." },
  { name: "My Desire", action: "Action", cost: 1, text: "You wanted their attention. Now you have all of it, and this fight ends when you say it does.\n\nTarget one Enemy within your melee reach. Make a standard melee attack. On a hit, deal normal damage. Until the start of your next turn, the target cannot willingly move away from you. It can still act, it can still fight, it can still close the distance. It just cannot put distance between you.\n\n• ***I See Red:*** The target also cannot benefit from effects that would move it, and can use its movement only to close with you, until the start of your next turn." },
  { name: "Churning My Direction", action: "Impulse", cost: 1, text: "The hit was meant for them. You have other ideas.\n\n*Trigger: An ally within 2 spaces is hit by an attack.* You instantly swap places with the ally and take the damage from the attack instead. You have **Resistance** to the damage taken this way.\n\n• ***I See Red:*** After you take the hit, you may immediately make a single standard melee attack against the attacker if they are within your reach." },
  { name: "On I Burn", action: "Impulse", cost: 1, text: "One body hits the floor. When you do it hard enough, everybody knows what comes next.\n\n*Trigger: You reduce an Enemy to 0 Vitality with a melee attack.* Each Enemy within **3 spaces** who can see you must succeed on a **Wits Save** (DC = 8 + your Body Modifier + your Caliber) or become *Shaken*.\n\n• ***I See Red:*** An Enemy that fails the Save is *Frightened* instead of *Shaken*." }
];
...
EN.classes.fury = {
  key: "fury",
  name: "The Fury",
  tagline: "You do not train to fight fair. You train to hit hardest, and you have learned that a body pushed past the point where it should quit is the most dangerous thing on the field.",
  ...
  attributePriorityNotes: [
    ...
    "2. Wits (Secondary): Powers Perception and Intuition to make sure you spot an Enemy ambush.",
  ...
  resource: {
    ...
    // store.js reads the rename table from here rather than restating it, the same way it
    // reads weapon-part and cyberware renames from their catalogs.
    abilityRenames: FURY_MANEUVER_RENAMES
  },
  startingProficiencies: {
  ...
  featuresByLevel: {
    "1": [
      ...
      { name: "Fury Subclass", text: "You choose a Fury subclass, representing your specialization. You gain all subclass features for which you meet the required Fury level, both now and as you advance. You may only select one subclass." }
    ],
    "2": [
      { name: "Relentless Advance", text: "Whenever you spend an Action to **Dash**, or whenever you spend Overdrive to activate a Maneuver that alters physical positioning (such as War Horse or Warhead), you gain **Vigor** equal to your Caliber + your Body Modifier and ignore movement penalties from Difficult Terrain for the duration of that turn." },
      { name: "Universal Upgrade", text: "Your Freelancer grows in a way that defines them. Choose one: increase one Attribute by 2, increase two Attributes by 1 each (to a maximum of 20), or select one Talent for which you meet the requirements." }
    ],
    "3": [
  ...
  subclasses: [
    {
      key: "juggernaut",
      name: "The Juggernaut",
      description: "The corporations sell subscriptions for proprietary chrome and mil-spec reflexes for more Glimmer each month than your block clears in a year. You match all of it with gravity, momentum, and a heavy slab of metal.\n\nYou have honed your body for the weight and rebuilt your armor around it. Every strap, plate, and rivet has passed through your hands. Whatever gear you can afford, you turn into an impenetrable fortress through perfect angling, overwhelming mass, and a sheer, terrifying refusal to yield the right-of-way.",
      features: [
        { level: 1, name: "The Walking Anvil", text: "Heavy debris, torn rebar, and broken furniture are lethal tools in your hands. Improvised weapons you wield step up one damage die, to a maximum of 1d12. Where the city sees a dead vending machine, you see a two-hundred-pound haymaker.\n\nWhile wearing Medium Armor, Heavy Armor, or wielding a Physical Shield, you gain Edge on all Saves and contested checks made to resist being pushed, pulled, or knocked Prone.\n\nWhenever you use the Beyond the Bone or Warhead Overdrive maneuver while wielding a melee weapon with the Heavy trait, an Improvised Weapon, or a Physical Shield, the target is shoved an additional 1 space back." },
        { level: 3, name: "Immovable", text: "As an **Impulse Action** when you would be pushed, pulled, knocked Prone, or otherwise moved against your will, spend 1 Overdrive to refuse. You do not move and you do not go down. Damage and any other effects of the source still resolve; only the movement fails. If the source is within your reach, it takes physical damage equal to your **Body Modifier**, its own momentum returned to sender. This refuses outside force only: if an effect dictates your own movement, your legs are the traitor, and this feature cannot stop them.\n\nIf an effect would tear an adjacent ally away instead, you can spend the Impulse Action and 1 Overdrive the same way: grab them, and they are not moved either.\n\nYou also count as an obstacle, not a bystander. When another Target is forcibly moved into you, their movement stops at your space and they take the full cut-short damage (**1d6 Bludgeoning per space denied**) rather than splitting the impact with you. You are not budged." },
        { level: 7, name: "Unstoppable Momentum", text: "As a **Swift Action**, spend 2 Overdrive to enter this state for up to 1 minute (or until the encounter ends): you drop your shoulder, and the mass takes over. While active, you gain Resistance to all physical damage, and your Speed cannot be reduced by external effects, Difficult Terrain, or conditions like Staggered. Mass this size does not travel for free: at the start of each of your turns, you lose Vigor equal to your Caliber (if you have no Vigor, you lose Vitality instead). You can end this state early as a free action on your turn. Stopping is the only part that costs nothing." },
  ...
  extra: {
    playbook: {
      ...
      winningEncounters: "You win by shattering the Enemy formation through sheer momentum and close quarters devastation. Whether you are using a physical shield to breach a chokepoint or a massive blade to clear a room, you brutally punish anyone foolish enough to stand their ground or target your support Allies.",
      whatToAvoid: "Getting pinned down in a ranged firefight or playing it safe behind cover. If you are not actively closing the distance, dictating the physical space, or throwing yourself into the chaos to protect a fellow Freelancer, your massive d12 Resilience is going to waste."
    },
