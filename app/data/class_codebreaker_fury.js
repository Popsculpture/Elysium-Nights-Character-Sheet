  ...
  subclasses: [
    ...
    },
    {
      ...
      features: [
        ...
        { level: 7, name: "Memetic Virus", text: "As an **Action**, spend 2 Bandwidth and force up to three enemies within 12 spaces to make a Wits Save (DC = 8 + your Tech Modifier + your Caliber). On a failure, they perceive an inescapable threat for 1 minute: they are Frightened of you and must use their movement to get away from you on their turn. If a Frightened target willingly moves closer to you, the dissonance deals it 4d6 Psychic damage. An affected target may repeat the Wits Save at the end of each of its turns to end the effect." },
        { level: 10, name: "Reality Overwrite", text: "Once per Long Rest, as an **Action**, spend 2 Bandwidth to overwrite an Area 20×20 Cube for 1 minute. Your squad is immune to the illusion, and your hardware bypasses the hard-light. All enemies inside the zone suffer:\n\n• **Foveated Disorientation:** The shifting labyrinth counts as Difficult Terrain (halving Speed), and they suffer continuous Snag on all attack rolls.\n• **Asymmetric Reality:** Because the hard-light solidifies only in response to enemy interactions, you control the battlefield's physical layout. Projections intercept enemy fire and block enemy Line of Sight; you and your allies gain Total Cover against ranged attacks made by enemies inside the zone.\n• **Sensory Rejection:** At the start of each of their turns, enemies must make a Wits Save (DC = 8 + your Tech Modifier + your Caliber). **On a failure:** They take 4d6 Psychic damage. **On a success:** They take half damage and map the geometry. Until the end of that turn, they ignore the area's Difficult Terrain penalty and your squad's Total Cover benefit; if they start their next turn still inside, they make that Wits Save with Edge." }
      ]
    },
    {
      key: "burner",
