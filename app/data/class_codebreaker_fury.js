...
var CODEBREAKER_GRID_EXPLOITS = [
  ...
  { name: "Trace Cutter", action: "Impulse Action", cost: 1, text: "Trigger: You would suffer the effects of an Alert response. Spend 1 Bandwidth to wipe the Alert from the node's logs before it propagates. The trace fails to advance. Recharge: If you Brick a Node before the end of your next turn, refund the 1 Bandwidth. Wiping the trace is worth the cost when you press the advantage instead of retreating." },
  { name: "Sympathetic Resonance", action: "Impulse Action", cost: 1, text: "Trigger: You would take damage from an IC Counterattack. Spend 1 Bandwidth to force the IC to roll its damage twice and take the lower result. Recharge: If the higher of the two damage rolls would have exceeded your Firewall threshold but the lower roll you keep does not, refund the 1 Bandwidth at the end of the turn. The spoof only pays for itself when it turns a real hit into a harmless one." },
  { name: "Cold Read", action: "Swift Action", cost: 1, text: "Spend 1 Bandwidth to scan a target you can see (visible person, vehicle, or device). You immediately learn the Tier and Cipher Save Bonus of any Node carried by, installed in, or operated by that target. You also learn what IC tier (if any) defends those Nodes. Recharge: If you establish a Link to, or Brick, one of the scanned target's Nodes before the end of your next turn, refund the 1 Bandwidth. Reconnaissance pays for itself when you act on it." },
  { name: "Brownout", action: "Action", cost: 1, text: "Target one enemy you can Scan and Breach that carries cybernetics or has the Machine Physiology trait. You force a cascading power dip through their hardware and drop their systems into a momentary lockout. The target must make a Body Save against your Cipher Save DC (8 + your Tech Modifier + your Caliber). On a failure, their cyberware sags and stutters: until the start of your next turn, they roll with Snag on attack rolls and their Speed is halved. This is a lockout, not a burnout; nothing is permanently damaged. Recharge: If the target is hit by an attack before the start of your next turn, refund the 1 Bandwidth at the end of the turn." },
  { name: "Targeting Spoof", action: "Impulse Action", cost: 1, text: "Trigger: An enemy you can see within 12 spaces targets you or an ally for an attack using networked optics, a Smart weapon, or similar targeting systems. By injecting corrupted data into their targeting solution at the critical moment of firing, you force the attacker to roll that attack with Snag. Recharge: You regain the 1 spent Bandwidth if the attack fails to hit its target." }
];
var CODEBREAKER_GRID_EXPLOITS_TEXT = "Signature #GRID Exploits\nYou have access to a suite of Signature #GRID Exploits: foundational class moves that no other class can replicate. You know all of the following Signature #GRID Exploits. Each costs 1 Bandwidth to activate. Each has a recharge trigger that, when met, refunds the spent Bandwidth. You may use any Signature #GRID Exploit any number of times, provided you have the Bandwidth to spend or recharge it through play.\n" + CODEBREAKER_GRID_EXPLOITS.map(function (e) {
  return "     " + e.name + (e.action ? " (" + e.action + ")" : "") + ": " + e.text;
}).join("\n");
  ...
  subclasses: [
    {
      ...
      features: [
        { level: 1, name: "Hardware Integration", text: "You treat physical machines as extensions of your own nervous system. You gain the following benefits:\n\n• **Tool Proficiency:** You gain Proficiency with Engineering Tools, allowing you to repair and customize robotic assets.\n\n• **Persistent Link:** You begin play with a custom Companion Drone (see profile below). You automatically maintain a permanent Link to your drone that does not count against your maximum active Links. If your drone is destroyed, you can rebuild it during a Long Rest by spending 𝒢100 in salvage and making a successful Engineering Dice Pool check.", nested: [{ name: "Companion Drone (Base Profile)", text: "• **Size:** Small (a rotor-drone, mechanical hound, treaded scout, or similar).\n• **Speed:** 6. Choose one of Flying, Climbing, or Ground movement at the time of build.\n• **Defense:** 12 + your Tech Modifier.\n• **Vitality:** 10 + (Codebreaker Level × 4).\n\n• **Action Economy:** On your turn, you may spend an **Impulse Action** to command the drone to move up to its speed and take one Action (attacking, interacting with an object, or taking the Help action).\n\n• **Attack (Mounted Sidearm or Taser):** d20 + your Tech Modifier vs Defense. Deals **1d6 + Tech Modifier** Piercing or Electric damage." }] },
...
var FURY_OVERDRIVE_INTRO = "The Fury relies on explosive bursts of adrenaline, cybernetic power, or pure rage called Overdrive. Overdrive represents physical feats that push past normal bodily limits to shatter the battlefield.\n\nYour Overdrive Pool\nYour maximum Overdrive is equal to your Caliber + your Body Modifier (minimum of 1). You regain all spent Overdrive at the end of a Short or Long Rest.\n\nOverdrive Maneuvers\nAt 1st Level you learn two Overdrive Maneuvers of your choice from the list below; you learn two more at 5th Level through Expanded Overdrive. Unless otherwise noted, all Overdrive Maneuvers cost 1 Overdrive to activate.\n\nCornered. A Fury is never more dangerous than when their own blood is up. Some Maneuvers are marked Cornered. While you are Bloodied, a Cornered Maneuver gains the additional effect listed in its description.";
var FURY_OVERDRIVE_MANEUVERS = [
  { name: "Wrecking Ball", action: "Action", cost: 1, text: "Target one Enemy within your melee reach. You wind up and put your whole body behind a single crushing blow, the kind meant to break something that does not grow back. Make a standard melee attack. On a hit, you deal an additional 1d8 Bludgeoning damage, and the trauma tears something loose inside them: the target gains 1 stack of Bleeding. Cornered: While you are Bloodied, the swing carries the weight of everything you have left. The target gains 2 stacks of Bleeding instead and is knocked Prone." },
  { name: "Clear the Path", action: "Action", cost: 1, text: "Target one Enemy within your melee reach. You put your entire body weight into a single, devastating swing designed to clear your immediate airspace. Make a standard melee attack. On a hit, you deal normal damage, and the target is violently pushed up to 3 spaces directly away from you. If the target is pushed into a solid obstacle (such as a wall, a vehicle, or another target), the target and the obstacle take additional Bludgeoning damage equal to your Body Modifier." },
  { name: "Seismic Stomp", action: "Action", cost: 1, text: "You slam the ground with devastating force. All enemies within 3 spaces of you must make an Agility Save (DC = 8 + your Body Modifier + your Caliber). On a failure, they take Bludgeoning damage equal to your Caliber + your Body Modifier and are inflicted with the Staggered condition (Speed halved, lose Swift and Impulse Actions) until the end of their next turn." },
  { name: "Bring the House Down", action: "Action", cost: 1, text: "Target one wall, pillar, vehicle, barricade, or similar large structure within your melee reach, or a point on the ground within reach. You stop fighting the people and start fighting the room. The structure is torn apart, or the floor is cratered, and the area within 2 spaces of that point becomes Difficult Terrain from the wreckage. Any Cover the destroyed object was providing is gone. Each Enemy within 2 spaces of the point must succeed on an Agility Save (DC = 8 + your Body Modifier + your Caliber) or be knocked Prone and take Bludgeoning damage equal to your Caliber from flying debris. Thanks to Collateral Damage, you can bring down reinforced structures that would normally be too solid to break in a single blow, though the GM may rule that truly massive or load-bearing targets need more than one." },
  { name: "Linebreaker", action: "Swift Action", cost: 1, text: "You drop your shoulder and become a living battering ram. Until the end of your turn, you can move through spaces occupied by enemies. If you pass through an enemy's space, they must make a Body Save (DC = 8 + your Body Modifier + your Caliber) or be knocked Prone." },
  { name: "Redline", action: "Swift Action", cost: 1, text: "You shove your body past the safety limits, spending your own reserves to buy a few seconds of pure violence. You take Vitality damage equal to your Caliber (this damage cannot be reduced or prevented). Until the end of your turn, each of your weapon attacks deals an additional 1d10 damage of the weapon's type. Cornered: While you are Bloodied, there is nothing left to spare and nothing left to lose. Redline costs you no Vitality, the bonus damage increases to 2d10, and your attacks ignore Resistance until the end of your turn." },
  { name: "Meat Shield", action: "Impulse Action", cost: 1, text: "Trigger: An ally within 2 spaces is hit by an attack. You throw your own body into the line of fire. You instantly swap places with the ally and take the damage from the attack instead of them. You have Resistance to the damage taken this way (halving the incoming damage). Cornered: While you are Bloodied, you are long past protecting yourself. After you take the hit, you may immediately make a single standard melee attack against the attacker if they are within your reach." },
  { name: "Make an Example", action: "Impulse Action", cost: 1, text: "Trigger: You reduce an Enemy to 0 Vitality with a melee attack. You make certain everyone watching understands exactly what happens to the next person who stands in your way. Each Enemy within 3 spaces who can see you must succeed on a Wits Save (DC = 8 + your Body Modifier + your Caliber) or become Shaken. Cornered: While you are Bloodied, the sight of you still upright and still swinging through your own wounds is a horror in itself. An Enemy that fails the save is Frightened instead of Shaken." }
];
