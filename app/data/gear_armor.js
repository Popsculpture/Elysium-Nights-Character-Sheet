...
EN.gearCatalog.armor = {
  ...
  items: [
    ...
    { name: "Liner Mesh", kind: "armor", group: "Light Armor", type: "Light Armor", price: 80,
      slot: ["Torso", "Legs"], dr: 1, traits: ["Concealable"], availability: "Common", legality: "Legal",
      ...
      effect: "Grants 1 Damage Reduction (DR)." },
    { name: "Hypeplate", kind: "armor", group: "Light Armor", type: "Light Armor", price: 120,
      slot: ["Torso", "Legs"], dr: 1, traits: ["Streetwear"], availability: "Common", legality: "Legal",
    ...
    { name: "Courier Shell", kind: "armor", group: "Light Armor", type: "Light Armor (1 Mod Slot)", price: 170,
      slot: ["Torso", "Legs"], dr: 2, slots: 1, traits: ["Streetwear", "Modular"], availability: "Common", legality: "Legal",
      ...
      effect: "Grants 2 Damage Reduction (DR). You gain Edge on in-combat Stealth d20 checks (or add +1 Edge Die to out-of-combat Dice Pools) in dim light or darkness." },
    ...
    { name: "Composite Kit", kind: "armor", group: "Medium Armor", type: "Medium Armor", price: 320,
      slot: ["Torso", "Legs"], dr: 3, traits: ["Hostile Appearance"], availability: "Common", legality: "Legal",
      ...
      effect: "Grants 3 Damage Reduction (DR)." },
    { name: "City Carrier", kind: "armor", group: "Medium Armor", type: "Medium Armor", price: 360,
      slot: ["Torso", "Legs"], dr: 3, blockBonus: 1, traits: ["Streetwear", "Plated", "Bulky"], availability: "Common", legality: "Legal",
    ...
    { name: "Gig Harness", kind: "armor", group: "Medium Armor", type: "Medium Armor (2 Mod Slots)", price: 390,
      slot: ["Torso", "Legs"], dr: 3, slots: 2, traits: ["Modular", "Load-Bearing"], availability: "Common", legality: "Legal",
    ...
    { name: "Vanguard Plate", kind: "armor", group: "Medium Armor", type: "Medium Armor", price: 580,
      ...
      desc: "A heavy medium suit that gives up the easy step for an extra layer of hard plate. As much armor as you can carry before you cross into the kind that climbs into you. Slow to move in, hard to drop.",
      effect: "Grants 4 Damage Reduction (DR) and a +1 Block Bonus." },
    { name: "Sentinel Issue", kind: "armor", group: "Medium Armor", type: "Medium Armor", price: 150, upkeep: 120, buyout: 1000, lapsedDR: 1,
      ...
      effect: "Grants 3 Damage Reduction (DR) and a +1 Block Bonus. Lapsed or Locked: DR drops to 1 and you lose the Block Bonus until you settle the account or crack the lock. It can be locked on lapsed payment, a flagged Persona, or revoked corporate credentials." },

    /* ============================== HEAVY ARMOR ============================== */
    { name: "Scrap Plate", kind: "armor", group: "Heavy Armor", type: "Heavy Armor", price: 600,
      slot: ["Torso", "Legs"], dr: 4, blockBonus: 2, traits: ["Plated", "Loud"], availability: "Common", legality: "Legal",
      ...
      effect: "Grants 4 Damage Reduction (DR) and a +2 Block Bonus." },
    { name: "Foundry Shell", kind: "armor", group: "Heavy Armor", type: "Heavy Armor", price: 680,
      slot: ["Torso", "Legs"], dr: 4, blockBonus: 2, traits: ["Plated", "Bulky", "Load-Bearing"], availability: "Common", legality: "Legal",
    ...
    { name: "Riot Wall", kind: "armor", group: "Heavy Armor", type: "Heavy Armor", price: 740,
      slot: ["Torso", "Legs"], dr: 4, blockBonus: 2, traits: ["Plated", "Bulky", "Sealed"], availability: "Uncommon", legality: "Licensed",
    ...
    { name: "Breaker Harness", kind: "armor", group: "Heavy Armor", type: "Heavy Armor (3 Mod Slots)", price: 860,
      slot: ["Torso", "Legs"], dr: 4, blockBonus: 2, slots: 3, traits: ["Plated", "Modular"], availability: "Uncommon", legality: "Restricted",
    ...
    { name: "Anvil Frame", kind: "armor", group: "Heavy Armor", type: "Heavy Armor", price: 920,
      slot: ["Torso", "Legs"], dr: 5, blockBonus: 2, traits: ["Plated", "Bulky", "Loud"], availability: "Uncommon", legality: "Restricted",
    ...
    { name: "Bastion Plate", kind: "armor", group: "Heavy Armor", type: "Heavy Armor (3 Mod Slots)", price: 980,
      slot: ["Torso", "Legs"], dr: 5, blockBonus: 2, slots: 3, traits: ["Plated", "Bulky", "Modular"], availability: "Rare", legality: "Restricted",
    ...
    { name: "Resonant Carapace", kind: "armor", group: "Mystech Armor", type: "Medium Mystech Armor (2 Mod Slots)", price: 1600, nexus: "◎0.5",
      ...
      desc: "Tuned mystech plate that hums against incoming force and feeds a fraction of every hit back into the wearer's Ward. The plating catches Flow as readily as it catches a round, which is why the things that bypass ordinary armor find no door here. Favored by Shapers who fight on the line instead of behind it.",
    ...
    /* ============================== PHYSICAL SHIELDS ============================== */
    { name: "Scrap Shield", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d4 Block, Wear 8)", price: 30,
      defense: 1, blockDie: "1d4", wear: 8, boxes: 2, traits: ["Off-Hand", "Loud", "Wear 8"], availability: "Common", legality: "Legal",
      ...
      effect: "Adds +1 to your Defense while wielded. It fully occupies the hand. It has only 2 Durability boxes instead of 3." },
    { name: "Ballistic Bracer", kind: "shield", group: "Physical Shield", type: "Physical Shield (+0 Defense, +1d4 Block, Wear 8)", price: 50,
      defense: 0, blockDie: "1d4", wear: 8, boxes: 3, traits: ["Light", "Off-Hand", "Wear 8"], availability: "Common", legality: "Legal",
    ...
    { name: "Riot Shield", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d6 Block, Wear 12)", price: 200,
    ...
    { name: "Sentinel Barrier", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d6 Block, Wear 12)", price: 90, upkeep: 60, buyout: 600,
      ...
      desc: "The leased, budget cousin of the Hardlight Barrier. A corporate emitter that throws the same plane of hardened light, billed by the week and stamped with whose it is. While the plan is current, it holds a wall. The morning the invoice bounces, the emitter stops lighting up and you are gripping a dead handle.",
      effect: "Adds +1 to your Defense while wielded. Its Durability boxes represent emitter overload rather than physical wear. Lapsed or Locked: the emitter goes dark, dropping to its zero state, no Defense bonus and no Block die, until you settle the account or crack the lock. It can be locked on lapsed payment, a flagged Persona, or revoked corporate credentials." },
    ...
    { name: "Hardlight Barrier", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d6 Block, Wear 12)", price: 450,
      ...
      desc: "A wrist projector that throws a plane of hardened light on command. Stowed, it is a bracelet nobody clocks. Raised, it is a shield that was not there a second ago, which is exactly long enough to ruin someone's aim. Prototype corporate tech, and very much not on a shelf anywhere.",
      effect: "Adds +1 to your Defense while wielded. It projects when you raise it to Block or enter Full Defense, at no extra cost to bring up, and fully occupies the hand while active. Stowed, the projector reads as a wrist unit or bracelet rather than a weapon. Its Durability boxes represent projector overload rather than physical wear." },

    /* ============================== WARDING FOCI ============================== */
    { name: "Scrap Ward", kind: "focus", group: "Warding Focus", type: "Warding Focus (+1d4 Ward)", price: 120,
      slot: "Accessories", wardDie: "1d4", traits: ["Worn", "Focus", "Mystech"], availability: "Common", legality: "Legal",
      desc: "A Flow charm wired together from salvaged resonant thread and the casing of a dead Node. It hums wrong, it runs hot against the skin, and it catches just enough of a hit to matter. The lower wards make their own, because nobody is selling them the real thing.",
    ...
    { name: "Resonance Coil", kind: "focus", group: "Warding Focus", type: "Warding Focus (+1d4 Ward)", price: 250,
      slot: "Accessories", wardDie: "1d4", traits: ["Worn", "Focus", "Mystech"], availability: "Uncommon", legality: "Licensed",
    ...
    { name: "Saint's Knot", kind: "focus", group: "Warding Focus", type: "Warding Focus (+1d6 Ward)", price: 600,
      slot: "Accessories", wardDie: "1d6", traits: ["Worn", "Focus", "Mystech"], availability: "Legendary", legality: "Restricted",
    ...
    { name: "Hex Lattice Projector", kind: "focus", group: "Warding Focus", type: "Warding Focus (+1d8 Ward)", price: 1200, nexus: "◎0.5",
      slot: "Accessories", wardDie: "1d8", traits: ["Worn", "Focus", "Mystech"], availability: "Legendary", legality: "Restricted",
