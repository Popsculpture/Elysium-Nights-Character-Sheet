...
EN.gearCatalog.armor = {
  ...
  traits: {
    ...
    "Bulky": "Rigid, layered, overbuilt. It fights your movement and it cannot hide. Increases the item's Load by 1, reduces your Speed by 1, and imposes Snag on Acrobatics and Stealth checks. Cannot be Concealable.",
    ...
    "Load-Bearing": "Reinforced webbing, hardpoints, and frame support for everything you have to haul. Your Encumbrance threshold counts as one step higher. This does not stack with the Load Distributor mod; if you have both, take the single step.",
    "Powered": "The armor carries its own power source and active systems. Running one takes Heavy Armor proficiency and dedicated training. Trained, you gain the suit's listed Powered Benefits. If the frame is unpowered, locked, or damaged, its Powered Benefits are lost and its drawbacks apply normally. Untrained, your Speed is reduced and you roll Agility checks with Snag.",
    ...
    "Off-Hand": "Carried, strapped, or braced on your off hand rather than your main hand. It fills your off-hand slot: you can use only one Off-Hand item at a time, and you cannot also wield a Two-Handed weapon. Whether the hand itself stays free for other tasks is set by the item (a strapped bracer leaves it usable; a gripped shield does not, as the entry says). Shields also use the Block, Full Defense, Stacking, and Shield Durability rules.",
    ...
    "Leased": "The armor is not yours; it runs on a corporate service plan, and the issuer keeps a finger on the off switch. You pay an Upkeep cost each period. Miss a payment, get flagged, or cross the issuer and the gear drops remotely to its zero state (armor to DR 0, a shield to no Defense bonus and no Block die) with its other traits switched off, until you pay what you owe or crack the lock. That zero state is the default: where an item's own Lapsed or Locked line lists a different value, that value governs instead. The holder can also repossess it outright. Cracked gear keeps working but scans as stolen corporate property.\n\nMost Leased entries also list a Buyout: a one-time lump sum, separate from Upkeep and never reduced by Upkeep already paid, that ends the lease outright and makes the gear yours. Paying Upkeep keeps the plan current. Only the Buyout closes it."
  },
  ...
  items: [
    ...
    { name: "Sentinel Issue", kind: "armor", group: "Medium Armor", type: "Medium Armor", price: 150, upkeep: 120, buyout: 1000,
    ...
    { name: "Bailiff Rig", kind: "armor", group: "Powered Exoframe", type: "Powered Heavy Armor (3 Mod Slots)", price: 430, upkeep: 400, nexus: "◎0.3 buyout",
    ...
    { name: "Scrap Shield", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d4 Block)", price: 30,
      defense: 1, blockDie: "1d4", boxes: 2, traits: ["Off-Hand", "Loud"], availability: "Common", legality: "Legal",
    ...
    { name: "Ballistic Bracer", kind: "shield", group: "Physical Shield", type: "Physical Shield (+0 Defense, +1d4 Block)", price: 50,
      defense: 0, blockDie: "1d4", boxes: 3, traits: ["Light", "Off-Hand"], availability: "Common", legality: "Legal",
    ...
    { name: "Riot Shield", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d6 Block)", price: 200,
      defense: 1, blockDie: "1d6", boxes: 3, coverOnFullDefense: "Half Cover", traits: ["Off-Hand"], availability: "Uncommon", legality: "Licensed",
    ...
    { name: "Sentinel Barrier", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d6 Block)", price: 90, upkeep: 60, buyout: 600,
      defense: 1, blockDie: "1d6", boxes: 3, emitter: true, traits: ["Off-Hand", "Leased"], availability: "Common", legality: "Licensed",
    ...
    { name: "Ballistic Bulwark", kind: "shield", group: "Physical Shield", type: "Physical Shield (+2 Defense, +1d8 Block)", price: 300,
      defense: 2, blockDie: "1d8", boxes: 3, coverOnFullDefense: "Three Quarter Cover", traits: ["Heavy", "Off-Hand"], availability: "Uncommon", legality: "Restricted",
    ...
    { name: "Hardlight Barrier", kind: "shield", group: "Physical Shield", type: "Physical Shield (+1 Defense, +1d6 Block)", price: 450,
      defense: 1, blockDie: "1d6", boxes: 3, emitter: true, traits: ["Concealable", "Off-Hand"], availability: "Uncommon", legality: "Restricted",
