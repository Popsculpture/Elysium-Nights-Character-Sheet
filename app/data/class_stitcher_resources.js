...
EN.resourceRules = {
  ...
  byClass: {
    ...
    /* The recovery line said 2 Bandwidth where the Codebreaker chapter's own SysAdmin (Root Access)
       says 3, because this summary and that feature were transcribed faithfully from two chapters
       of the book that disagreed. Found 2026-09-18 while settling the Hardware Mastery filing;
       Brandon ruled 3 and corrected the manuscript, so this now agrees with the other two sites,
       class_codebreaker_fury.js (the level 9 feature) and briefs.js (its one-line brief).

       The number is prose in all three places. Nothing computes it, so there is no engine path to
       keep in step, only these strings. */
    bandwidth: "Codebreaker: Bandwidth\n\nThe Codebreaker's resource is Bandwidth. It represents cognitive throughput, neural overclocking, Smartdeck strain tolerance, and the ability to force the #GRID to obey your will. The Codebreaker entry already defines this pool and its uses.\n\nBandwidth Pool\nMaximum Bandwidth = Caliber + Tech Modifier (minimum 1)\n\nRefresh\nYou regain all spent Bandwidth at the end of a Short Rest or Long Rest.\n\nWhat Bandwidth Fuels\nBandwidth fuels #GRID Exploits and subclass-specific digital escalation.\n\nExamples include:\nFlash Breach, Cipher Overdrive, Targeting Spoof, Rigger drone support features and other subclass interactions that rely on Bandwidth-backed #GRID control.\n\nExample\nA Level 9 Codebreaker has Caliber 5 and Tech 20 for a +5 Tech Modifier. Their maximum Bandwidth is 10.\n\nBandwidth Recovery Features\nSome Codebreaker features restore Bandwidth in play. #GRID Initiative restores 3 Bandwidth when you roll Initiative while empty."
  },
